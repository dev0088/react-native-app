...
class IntroduceLearnScreen extends React.Component {
	static defaultProps = {
		error: null
	}
	...
	componentWillMount = () => {
		this.props.onboardingActions.checkedOnboardingLearn()
	}
			...
			<Container>
				...
				<Content style={styles.content}>
					<View style={styles.slideShow}>
						<Spacer size={72} />
						<View>
							<H1 style={styles.header3}>Learn - </H1>
						</View>
						<Spacer size={19} />
						<Text style={styles.description}>
							1. Our Snippet Library of 60 second videos & Additional Resources of Content that you need when you need it.
						</Text>
						<Spacer size={19} />
						<Text style={styles.description}>
...
export default connect(mapStateToProps, mapDispatchToProps)(IntroduceLearnScreen)
